...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('frontend/img/icon1.png') }}" />
...
@include('frontend.layouts.footer')
    <!-- Facebook commend js -->
  <div id="fb-root"></div>
  <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v13.0" nonce="CCBiQgaD"></script>
    <!-- jquery js -->
